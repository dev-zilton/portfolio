...
export function Hero({ onContact }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-turquoise-400/10 blur-[120px]" />
      <div className="absolute right-0 top-1/3 h-[400px] w-[400px] rounded-full bg-accent-purple/10 blur-[100px]" />
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="order-1 flex justify-center md:order-2">
            <div className="relative h-[17rem] w-64 md:h-[22rem] md:w-80">
              <div className="absolute inset-0 scale-105 rotate-12 rounded-[40%_60%_70%_30%_/_40%_60%_30%_70%] bg-gradient-to-br from-turquoise-400/25 to-accent-purple/25 blur-2xl" />
